			...
			<div class="col-6">
                <div class="card">
                    <div class="card-header">
                        <h1 class="text-center">Produits Approvisionnements</h1>
                    </div>
                    <div class="card-body">
                     <form action="saveapp" method="get">
					...
					<tr>
					<td><s:textfield label="datePrevueLivraison" name="produit.datePrevueLivraison" labelposition="left" class="form-control"></s:textfield></td>
					</tr>
					<tr>
					<td>	
						<s:hidden name="Modea"></s:hidden>	
					</td>
					</tr>			
